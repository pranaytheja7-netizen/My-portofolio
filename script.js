...
// Skills radio button functionality
document.querySelectorAll('input[name="skills"]').forEach(radio => {
...
document.querySelectorAll('.portfolio-item, .contact-item, .about-image, .about-content').forEach(el => {
    el.style.opacity = '0';
